        ...
        class << self
          ...
          def format_spellout_numbering(n)
            ...
            if is_fractional and (n > 1) then
              return ((format_spellout_numbering(n.floor) + "点") + format_spellout_numbering((n % 10)))
            end
            return n.to_s if (n >= 1000000000000000000)
            if (n >= 10000000000000000) then
              return ((format_spellout_numbering((n / 10000000000000000).floor) + "京") + (if ((n == 10000000000000000) or ((n % 10) == 0)) then
                ""
              else
            ...
            if (n >= 1000000000000) then
              return ((format_spellout_numbering((n / 1000000000000).floor) + "兆") + (if ((n == 1000000000000) or ((n % 10) == 0)) then
                ""
              else
                format_number8((n % 1000000000000))
              end))
            end
            if (n >= 100000000) then
              return ((format_spellout_numbering((n / 100000000).floor) + "亿") + (if ((n == 100000000) or ((n % 10) == 0)) then
                ""
              else
                format_number5((n % 100000000))
              end))
            end
            if (n >= 10000) then
              return ((format_spellout_numbering((n / 10000).floor) + "万") + (((n == 10000) or ((n % 10) == 0)) ? ("") : (format_number4((n % 10000)))))
            end
            if (n >= 1000) then
              return ((format_spellout_numbering((n / 1000).floor) + "千") + (((n == 1000) or ((n % 10) == 0)) ? ("") : (format_number3((n % 1000)))))
            end
            if (n >= 100) then
              return ((format_spellout_numbering((n / 100).floor) + "百") + (((n == 100) or ((n % 10) == 0)) ? ("") : (format_number2((n % 100)))))
            end
            if (n >= 20) then
          ...
          def format_spellout_cardinal_financial(n)
            ...
            if (n >= 100000000) then
              return ((format_spellout_cardinal_financial((n / 100000000).floor) + "亿") + (if ((n == 100000000) or ((n % 10) == 0)) then
                ""
              else
            ...
            if (n >= 10000) then
              return ((format_spellout_cardinal_financial((n / 10000).floor) + "万") + (if ((n == 10000) or ((n % 10) == 0)) then
                ""
              else
          ...
          def format_spellout_cardinal(n)
            ...
            if is_fractional and (n > 1) then
              return ((format_spellout_cardinal(n.floor) + "点") + format_spellout_cardinal((n % 10)))
            end
            return n.to_s if (n >= 1000000000000000000)
            if (n >= 10000000000000000) then
            ...
            if (n >= 100000000) then
              return ((format_spellout_cardinal((n / 100000000).floor) + "亿") + (if ((n == 100000000) or ((n % 10) == 0)) then
                ""
              else
            ...
            if (n >= 10000) then
              return ((format_spellout_cardinal((n / 10000).floor) + "万") + (((n == 10000) or ((n % 10) == 0)) ? ("") : (format_cardinal4((n % 10000)))))
            end
            if (n >= 1000) then
          ...
          def format_spellout_cardinal_alternate2(n)
            ...
            if (n >= 100000000) then
              return ((format_spellout_cardinal_alternate2((n / 100000000).floor) + "亿") + (if ((n == 100000000) or ((n % 10) == 0)) then
                ""
              else
            ...
            if (n >= 10000) then
              return ((format_spellout_cardinal_alternate2((n / 10000).floor) + "万") + (if ((n == 10000) or ((n % 10) == 0)) then
                ""
              else
