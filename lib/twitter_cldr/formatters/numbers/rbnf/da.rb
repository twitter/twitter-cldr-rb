      ...
      class Danish::Spellout
        class << self
          def format_spellout_numbering_year(n)
            ...
            if (n >= 1100) then
              return ((format_spellout_numbering_year((n / 10000).floor) + "­hundred") + (if ((n == 1100) or ((n % 10) == 0)) then
                ""
              else
          ...
          def format_spellout_cardinal_reale(n)
            ...
            if (n >= 2000000000000000) then
              return ((format_spellout_cardinal_reale((n / 10000000000000000).floor) + " billiarder") + (if ((n == 2000000000000000) or ((n % 10) == 0)) then
                ...
                (" og " + format_spellout_cardinal_reale((n % 10000000000000000)))
              end))
            end
            if (n >= 1000000000000000) then
              return ("en billiard" + (if ((n == 1000000000000000) or ((n % 10) == 0)) then
                ""
              else
            ...
            if (n >= 2000000000000) then
              return ((format_spellout_cardinal_reale((n / 10000000000000).floor) + " billioner") + (if ((n == 2000000000000) or ((n % 10) == 0)) then
                ...
                (" og " + format_spellout_cardinal_reale((n % 10000000000000)))
              end))
            end
            if (n >= 1000000000000) then
              return ("en billion" + (if ((n == 1000000000000) or ((n % 10) == 0)) then
                ""
              else
            ...
            if (n >= 2000000000) then
              return ((format_spellout_cardinal_reale((n / 10000000000).floor) + " milliarder") + (if ((n == 2000000000) or ((n % 10) == 0)) then
                ...
                (" og " + format_spellout_cardinal_reale((n % 10000000000)))
              end))
            end
            if (n >= 1000000000) then
              return ("en milliard" + (if ((n == 1000000000) or ((n % 10) == 0)) then
                ""
              else
            ...
            if (n >= 2000000) then
              return ((format_spellout_cardinal_reale((n / 10000000).floor) + " millioner") + (if ((n == 2000000) or ((n % 10) == 0)) then
                ...
                (" og " + format_spellout_cardinal_reale((n % 10000000)))
              end))
            end
            if (n >= 1000000) then
              return ("en million" + (if ((n == 1000000) or ((n % 10) == 0)) then
                ""
              else
            ...
            if (n >= 2000) then
              return ((format_spellout_cardinal_neuter((n / 10000).floor) + " tusind") + (if ((n == 2000) or ((n % 10) == 0)) then
                ""
              else
                (" og " + format_spellout_cardinal_reale((n % 10000)))
              end))
            end
            if (n >= 1000) then
              return ("et tusinde" + (if ((n == 1000) or ((n % 10) == 0)) then
                ""
              else
            ...
            if (n >= 200) then
              return ((format_spellout_cardinal_neuter((n / 1000).floor) + "­hundred") + (if ((n == 200) or ((n % 10) == 0)) then
                ""
              else
                (" og " + format_spellout_cardinal_reale((n % 1000)))
              end))
            ...
            if (n >= 100) then
              return ("et­hundrede" + (if ((n == 100) or ((n % 10) == 0)) then
                ""
              else
