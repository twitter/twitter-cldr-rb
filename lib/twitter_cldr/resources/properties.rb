...
module TwitterCldr
  module Resources
    module Properties
      ...
      autoload :EmojiSequencesImporter,                  'twitter_cldr/resources/properties/emoji_sequences_importer'
      autoload :EmojiZwjSequencesImporter,               'twitter_cldr/resources/properties/emoji_zwj_sequences_importer'
